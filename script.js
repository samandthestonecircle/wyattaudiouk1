...
function lightToggle(){
    ...
    if (getComputedStyle(light).display === "none") {
        ...
        document.getElementById("pedal-display-container").style.backgroundImage = 'url(display-off.png)';
    }

    if (getComputedStyle(light).display === "block") {
        pedalOperation();
        document.getElementById("pedal-display-container").style.backgroundImage = 'url(pedal-display.png)';
    }
